...
µBlock.updateBadgeAsync = (function() {
    ...
    var updateBadge = function(tabId) {
        ...
        if (µb.userSettings.showIconBadge
            && netFiltering) {
            badge = µb.utils.formatCount(pageStore.perLoadBlockedRequestCount + pageStore.perLoadBlockedFlashCount + pageStore.perLoadBlockedFingerprintingCount + pageStore.perLoadBlockedEmailCount + pageStore.perLoadBlockedKeyboardCount + pageStore.perLoadBlockedMouseCount + pageStore.perLoadBlockedMicrophoneCount);
        }
    ...
    return function(tabId) {
        ...
        tabIdToTimer[tabId] = setTimeout(updateBadge.bind(null, tabId), 100);
    };
})();
